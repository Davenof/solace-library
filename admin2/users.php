 ...
 <div class="container" style="clear:both">
        <form onSubmit="search_users(event)">
            <div class="search_area">
                <select id="search_ch" autocomplete="off" multiple="multiple" onChange="update_search_selection(event, 'users')"><option selected value="search">Search</option> <option value="all" selected="selected">Show all Users</option></select>
                <select style="display:none" id="subject"></select>
