...
<body>
    <header>
        <div class="top-header">
            ...
            <span id="header-contact">Contact SOL <a href="mailto:info@dol.fake" target="_blank">&#9993; info@sol.city</a> | <a href="tel:0790XX1X000">&#9742; 0790XX1X000</a></span>
        </div>
        ...
        <div class="nav-menu" id="navigator_hdvnk" data-active="<?php echo @$active_link; ?>">
            <ul>
                <li><a id="home_link" href="<?php echo glob_site_url; ?>">Menu</a></li>
            </ul>  
        </div> 
    </header>